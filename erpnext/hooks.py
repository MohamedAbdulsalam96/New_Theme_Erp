...
doc_events = {
	...
	"Sales Invoice": {
		...
		"validate"  : ["erpnext.accounts.accounts_custom_methods.validations","erpnext.accounts.accounts_custom_methods.add_data_in_work_order_assignment", "tools.tools_management.custom_methods.validate_reserve_fabric", "tools.tools_management.custom_methods.merge_tailoring_items", "erpnext.accounts.accounts_custom_methods.invoice_validation_method"],
